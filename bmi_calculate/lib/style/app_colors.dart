...
class AppTheme {
  ...
  static const Color underweightColor = Color(0xFF87B1D9);
  static const Color normalColor = Color(0xFF3DD365);
  static const Color overweightColor = Color(0xFFEEE133);
  static const Color obeseColor = Color(0xFFFD802E);
  static const Color extremeColor = Color(0xFFF95353);
